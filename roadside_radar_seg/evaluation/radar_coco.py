"""
Copied from pycocotools. Adated to calculate point cluster iou instead of box iou
"""
    ...
    def createIndex(self):
        ...
        if "annotations" in self.dataset:
            for ann in self.dataset["annotations"]:
                imgToAnns[ann["pcd_id"]].append(ann)
                anns[ann["id"]] = ann

        if "pcds" in self.dataset:
            for img in self.dataset["pcds"]:
                imgs[img["id"]] = img
        ...
        if "annotations" in self.dataset and "categories" in self.dataset:
            for ann in self.dataset["annotations"]:
                catToImgs[ann["category_id"]].append(ann["pcd_id"])
